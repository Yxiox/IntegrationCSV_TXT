...
public class ParticipanteController : ControllerHelper
{
    ...
    [Add]
    public async Task<IActionResult> InserirAsync(PARTICIPANTES participante, CancellationToken cancellationToken)
    {
    ...
    [Update]
    public async Task<IActionResult> UpdateAsync(PARTICIPANTES participante, CancellationToken cancellationToken)
    {
